...
const courses = [
  ...
  { icon: '💰', tag: 'Finance', tc: 'rgba(34,197,94,.75)', tb: 'rgba(34,197,94,.06)', bc: 'rgba(34,197,94,.1)', title: 'Savings & Investing', desc: 'Personal finance, budgeting, stock market basics, mutual funds, and building wealth through smart investing.' },
]
      ...
      <div className="footer-wrap">
        <footer>
          <div className="ft">
            ...
            <div className="fc"><h4>Courses</h4><a href="#">Generative AI</a><a href="#">Web Development</a><a href="#">Digital Marketing</a><a href="#">Java Programming</a><a href="#">C++ Fundamentals</a><a href="#">Savings & Investing</a></div>
