...
const courses = [
  ...
  { icon: '📊', tag: 'Data', tc: 'rgba(59,130,246,.75)', tb: 'rgba(59,130,246,.06)', bc: 'rgba(59,130,246,.1)', title: 'Data Science', desc: 'Python, pandas, NumPy, data visualization, machine learning basics, and statistical analysis.' },
]
      ...
      <div className="footer-wrap">
        <footer>
          <div className="ft">
            ...
            <div className="fc"><h4>Courses</h4><a href="#">Generative AI</a><a href="#">Web Development</a><a href="#">Digital Marketing</a><a href="#">Java Programming</a><a href="#">C++ Fundamentals</a><a href="#">Data Science</a></div>
